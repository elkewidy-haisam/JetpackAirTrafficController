...
---
# Codebase Source Tree and Class Documentation

*This section provides a comprehensive overview of the entire codebase structure, organized by package, with brief descriptions of each class's instance variables and methods.*

## Table of Contents - Packages

- [com.example (root)](#comexample-root)
- [com.example.accident](#comexampleaccident)
- [com.example.city](#comexamplecity)
- [com.example.controller](#comexamplecontroller)
- [com.example.detection](#comexampledetection)
- [com.example.flight](#comexampleflight)
- [com.example.grid](#comexamplegrid)
- [com.example.jetpack](#comexamplejetpack)
- [com.example.logging](#comexamplelogging)
- [com.example.manager](#comexamplemanager)
- [com.example.map](#comexamplemap)
- [com.example.model](#comexamplemodel)
- [com.example.navigation](#comexamplenavigation)
- [com.example.parking](#comexampleparking)
- [com.example.radio](#comexampleradio)
- [com.example.renderer](#comexamplerenderer)
- [com.example.ui.citymap](#comexampleuicitymap)
- [com.example.ui.frames](#comexampleuiframes)
- [com.example.ui.panels](#comexampleuipanels)
- [com.example.ui.utility](#comexampleuiutility)
- [com.example.util](#comexampleutil)
- [com.example.utility](#comexampleutility)
- [com.example.utility.geometry](#comexampleutilitygeometry)
- [com.example.utility.jetpack](#comexampleutilityjetpack)
- [com.example.utility.map](#comexampleutilitymap)
- [com.example.utility.performance](#comexampleutilityperformance)
- [com.example.utility.reflection](#comexampleutilityreflection)
- [com.example.utility.timezone](#comexampleutilitytimezone)
- [com.example.utility.water](#comexampleutilitywater)
- [com.example.weather](#comexampleweather)
...
**Purpose**: Bootstraps the entire application by initializing the Swing-based GUI and processing command-line
...
**Purpose**: Provides a streamlined entry point for rapid application testing during development. Initializes
...
**Purpose**: Provides accident functionality within the jetpack air traffic control application.

**Instance Variables**: `accidentID`, `x`, `y`, `type`, `severity`, `description`, `timestamp`, `isActive`

**Key Methods**: `getAccidentID()`, `getX()`, `getY()`, `getType()`, `getSeverity()`, `getDescription()`, `getTimestamp()`, `isActive()`, `setActive()`

### AccidentAlert

**File**: `AccidentAlert.java`  
**Package**: `com.example.accident`

**Purpose**: Central registry for accident incidents within the controlled airspace, maintaining active accident

**Instance Variables**: `accidentID`, `x`, `y`, `type`, `severity`, `description`, `timestamp`, `isActive`, `accidents`, `alertId`

**Key Methods**: `getAccidentID()`, `getX()`, `getY()`, `getType()`, `getSeverity()`, `getDescription()`, `getTimestamp()`, `isActive()`, `setActive()`, `reportAccident()`, `getAccidents()`, `getAccidentsNearLocation()`, `alertJetpacksOfAccident()`, `removeAlert()`, `getActiveAccidentCount()`

### AccidentReporter

**File**: `AccidentReporter.java`  
**Package**: `com.example.accident`

**Purpose**: Provides accidentreporter functionality within the jetpack air traffic control application.

**Instance Variables**: `cityRadio`, `city`, `random`, `logManager`, `radioInstructionsArea`, `movementLogger`

**Key Methods**: `setRadioInstructionsArea()`, `setMovementLogger()`, `reportRandomAccident()`, `reportAccident()`
...
**Purpose**: Provides city functionality within the jetpack air traffic control application.

**Instance Variables**: `name`, `width`, `height`, `parkingSpaces`

**Key Methods**: `getName()`, `getWidth()`, `getHeight()`, `getParkingSpaces()`, `setParkingSpaces()`
...
**Purpose**: Serves as the central command-and-control hub integrating all subsystems required for safe

**Instance Variables**: `controllerID`, `location`, `managedJetpacks`, `radio`, `radar`, `weather`, `accidentAlert`, `grid`, `dayTime`, `activeFlightPaths`, `isOperational`

**Key Methods**: `registerJetpack()`, `unregisterJetpack()`, `createFlightPath()`, `updateJetpackPosition()`, `reportAccident()`, `clearAccident()`, `updateWeather()`, `performSystemCheck()`, `checkForCollisions()`, `emergencyShutdown()`, `restart()`, `getControllerID()`, `getLocation()`, `getManagedJetpacks()`, `getRadio()`
...
**Purpose**: Continuously analyzes jetpack positions to identify unsafe proximity situations and actual collisions.

**Instance Variables**: `radarTape`, `accidentAlert`, `accidentCounter`

**Key Methods**: `setRadarTape()`, `getAccidentAlert()`, `checkCollisions()`, `getWarningDistance()`, `getCriticalDistance()`
...
**Purpose**: Implements a radar system that continuously monitors jetpack positions, detects proximity conflicts,

**Instance Variables**: `trackedJetpacks`, `radarRange`, `scanInterval`, `isActive`, `radarID`, `centerX`, `centerY`, `x`, `y`, `altitude`, `lastUpdated`, `isTracked`

**Key Methods**: `updatePosition()`, `getX()`, `getY()`, `getAltitude()`, `getLastUpdated()`, `isTracked()`, `getJetPackPositions()`, `updateJetPackPosition()`, `addJetpackToRadar()`, `removeJetpackFromRadar()`, `identifyAircraft()`, `getJetpacksInRadius()`, `checkForCollisions()`, `performRadarSweep()`, `getRadarRange()`

## Package: `com.example.flight`

### FlightEmergencyHandler

**File**: `FlightEmergencyHandler.java`  
**Package**: `com.example.flight`

**Purpose**: Handles critical flight situations requiring immediate intervention: emergency landings, altitude

**Instance Variables**: `radioDestination`, `radioAltitude`, `followingRadioInstruction`, `callsign`, `mapImage`, `logger`, `radioListener`

**Key Methods**: `setEmergencyLogger()`, `setRadioInstructionListener()`, `setMapImage()`, `receiveCoordinateInstruction()`, `receiveAltitudeInstruction()`, `receiveEmergencyLandingInstruction()`, `findEmergencyLandingSpot()`, `generateEmergencyDetour()`, `checkRadioDestinationReached()`, `checkRadioAltitudeReached()`, `clearInstructions()`, `getRadioDestination()`, `getRadioAltitude()`, `isFollowingRadioInstruction()`

### FlightHazardMonitor

**File**: `FlightHazardMonitor.java`  
**Package**: `com.example.flight`

**Purpose**: Continuously tracks multiple hazard types (inclement weather, building collapses, air accidents,

**Instance Variables**: `inclementWeather`, `buildingCollapse`, `airAccident`, `policeActivity`, `emergencyHalt`

**Key Methods**: `getActiveHazards()`, `hasActiveHazards()`, `calculateEffectiveSpeed()`, `getHazardStatus()`, `clearAllHazards()`, `clearEmergencyHalt()`, `setInclementWeather()`, `setBuildingCollapse()`, `setAirAccident()`, `setPoliceActivity()`, `setEmergencyHalt()`, `isInclementWeather()`, `isBuildingCollapse()`, `isAirAccident()`, `isPoliceActivity()`

### FlightMovementController

**File**: `FlightMovementController.java`  
**Package**: `com.example.flight`

**Purpose**: Implements the core movement logic for jetpack flights, computing incremental position updates

**Instance Variables**: `x`, `y`, `destination`, `speed`, `altitude`, `trail`, `waypoints`, `detourWaypoints`, `isDetourActive`, `currentWaypointIndex`, `cityModel`

**Key Methods**: `updatePosition()`, `getActiveTarget()`, `hasReachedDestination()`, `setNewDestination()`, `addWaypoint()`, `setWaypoints()`, `detour()`, `resumeNormalPath()`, `setEmergencyDestination()`, `updateAltitude()`, `getDirectionAngle()`, `getDistanceToDestination()`, `getDirectionString()`, `getX()`, `getY()`

### FlightPath

**File**: `FlightPath.java`  
**Package**: `com.example.flight`

**Purpose**: Models an ATC-approved flight plan containing origin, destination, and intermediate waypoints.

**Instance Variables**: `pathID`, `origin`, `destination`, `waypoints`, `detourWaypoints`, `isDetourActive`, `inclementWeather`, `buildingCollapse`, `airAccident`, `policeActivity`, `emergencyHalt`, `isActive`, `currentStatus`

**Key Methods**: `setFlightPath()`, `getFlightPath()`, `detour()`, `halt()`, `resumeNormalPath()`, `clearEmergencyHalt()`, `getActiveHazards()`, `hasActiveHazards()`, `getPathID()`, `setPathID()`, `getOrigin()`, `setOrigin()`, `getDestination()`, `setDestination()`, `getWaypoints()`

### JetPackFlight

**File**: `JetPackFlight.java`  
**Package**: `com.example.flight`

**Purpose**: Encapsulates a complete flight operation from origin to destination, managing position updates,

**Instance Variables**: `jetpack`, `color`, `baseColor`, `movementLogger`, `flightStateProvider`, `movementController`, `hazardMonitor`, `emergencyHandler`, `isActive`, `currentStatus`, `pathID`

**Key Methods**: `getDirectionAngle()`, `setMovementLogger()`, `setFlightStateProvider()`, `setMapImage()`, `setRadioInstructionListener()`, `onInstructionReceived()`, `onInstructionCompleted()`, `receiveCoordinateInstruction()`, `receiveAltitudeInstruction()`, `receiveEmergencyLandingInstruction()`, `updatePosition()`, `hasReachedDestination()`, `setNewDestination()`, `addWaypoint()`, `setWaypoints()`

### JetPackFlightRenderer

**File**: `JetPackFlightRenderer.java`  
**Package**: `com.example.flight`

**Purpose**: Handles rendering logic for jetpackflight using appropriate

**Instance Variables**: `x`, `y`, `altitude`, `destination`, `activeTarget`, `color`, `callsign`, `isParked`, `isEmergencyHalt`, `isDetourActive`, `hasActiveHazards`, `trail`, `waypoints`, `currentWaypointIndex`

**Key Methods**: `renderFlight()`

### JetPackFlightState

**File**: `JetPackFlightState.java`  
**Package**: `com.example.flight`

**Purpose**: Provides jetpackflightstate functionality within the jetpack air traffic control application.

**Instance Variables**: `flight`, `targetParking`, `isParked`, `parkingTimeRemaining`, `random`, `availableParkingSpaces`, `radarTapeWindow`, `movementLogger`, `repaintCallback`

**Key Methods**: `setRepaintCallback()`, `setRadarTapeWindow()`, `setMovementLogger()`, `updateParkingState()`, `isParked()`, `getAvailableParkingSpaces()`, `update()`
...
**Purpose**: Provides grid functionality within the jetpack air traffic control application.

**Instance Variables**: `width`, `height`, `gridType`, `localeName`, `coordinateSystem`

**Key Methods**: `displayGrid()`, `updateGrid()`, `setCoordinateSystem()`, `getGridInfo()`
...
**Purpose**: Handles rendering logic for grid using appropriate

**Instance Variables**: `grid`, `visible`, `gridColor`, `labelColor`, `gridSpacing`

**Key Methods**: `setVisible()`, `isVisible()`, `toggleVisibility()`, `setGridSpacing()`, `setGridColor()`, `render()`, `getGridCoordinates()`
...
**Purpose**: Provides jetpack functionality within the jetpack air traffic control application.

**Instance Variables**: `id`, `serialNumber`, `callsign`, `ownerName`, `year`, `model`, `manufacturer`, `position`, `altitude`, `speed`, `isActive`, `lastUpdate`

**Key Methods**: `createForCity()`, `resetCallsignCounter()`, `getId()`, `getSerialNumber()`, `getCallsign()`, `getOwnerName()`, `getYear()`, `getModel()`, `getManufacturer()`, `getPosition()`, `getAltitude()`, `getSpeed()`, `isActive()`, `getLastUpdate()`, `setPosition()`

## Package: `com.example.logging`

### CityLogManager

**File**: `CityLogManager.java`  
**Package**: `com.example.logging`

**Purpose**: Manages log instances across the Air Traffic Controller system, providing

**Instance Variables**: `cityJetpackLogFiles`, `cityRadarLogFiles`, `cityWeatherLogFiles`, `cityAccidentLogFiles`

**Key Methods**: `writeToJetpackLog()`, `writeToRadarLog()`, `writeToWeatherLog()`, `writeToAccidentLog()`, `getRadarLog()`
...
**Key Methods**: `saveAccidentReport()`, `listAccidentReports()`, `getAccidentsDirectory()`

### CityDisplayUpdater

**File**: `CityDisplayUpdater.java`  
**Package**: `com.example.manager`

**Purpose**: Provides citydisplayupdater functionality within the jetpack air traffic control application.

**Instance Variables**: `weatherLabel`, `dateTimeLabel`

**Key Methods**: `setWeatherLabel()`, `setDateTimeLabel()`, `updateWeatherDisplay()`, `updateDateTimeDisplay()`, `getWeatherLabel()`, `getDateTimeLabel()`

### CityJetpackManager

**File**: `CityJetpackManager.java`  
**Package**: `com.example.manager`

**Purpose**: Manages jetpack instances across the Air Traffic Controller system, providing

**Instance Variables**: `cityJetpacks`

**Key Methods**: `getJetpacksForCity()`, `getAllCityJetpacks()`, `getCities()`

### CityTimerManager

**File**: `CityTimerManager.java`  
**Package**: `com.example.manager`

**Purpose**: Manages timer instances across the Air Traffic Controller system, providing

**Instance Variables**: `weatherTimer`, `dateTimeTimer`, `animationTimer`

**Key Methods**: `startWeatherTimer()`, `startDateTimeTimer()`, `stopWeatherTimer()`, `stopDateTimeTimer()`, `stopAnimationTimer()`, `stopAllTimers()`, `setAnimationTimer()`, `getWeatherTimer()`, `getDateTimeTimer()`, `getAnimationTimer()`

### FlightHazardManager

**File**: `FlightHazardManager.java`  
**Package**: `com.example.manager`

**Purpose**: Manages hazard instances across the Air Traffic Controller system, providing

**Instance Variables**: `inclementWeather`, `buildingCollapse`, `airAccident`, `policeActivity`, `emergencyHalt`, `currentStatus`

**Key Methods**: `setInclementWeather()`, `setBuildingCollapse()`, `setAirAccident()`, `setPoliceActivity()`, `setEmergencyHalt()`, `clearEmergencyHalt()`, `getActiveHazards()`, `hasActiveHazards()`, `getCurrentStatus()`, `isEmergencyHalt()`, `isInclementWeather()`, `isBuildingCollapse()`, `isAirAccident()`, `isPoliceActivity()`, `getEffectiveSpeed()`

### RadioInstructionManager

**File**: `RadioInstructionManager.java`  
**Package**: `com.example.manager`

**Purpose**: Manages instruction instances across the Air Traffic Controller system, providing

**Instance Variables**: `cityRadio`, `currentWeather`, `city`, `random`, `logManager`, `radioInstructionsArea`

**Key Methods**: `setWeather()`, `setRadioInstructionsArea()`, `issueRandomRadioInstruction()`

## Package: `com.example.map`

### RealisticCityMap

**File**: `RealisticCityMap.java`  
**Package**: `com.example.map`

**Purpose**: Provides realisticcitymap functionality within the jetpack air traffic control application.

**Instance Variables**: `mapImage`, `cityName`, `imageLoaded`, `parkingSpaces`, `y`, `id`, `occupied`

**Key Methods**: `getParkingSpaces()`, `doInBackground()`, `done()`, `paintComponent()`, `getMapImage()`, `isImageLoaded()`
...
**Purpose**: Provides accidentalert functionality within the jetpack air traffic control application.

**Instance Variables**: `description`, `timestamp`, `location`, `jetpackId`, `severity`

**Key Methods**: `getDescription()`, `getTimestamp()`, `getLocation()`, `getJetpackId()`, `getSeverity()`
...
**Purpose**: Provides airtrafficcontroller functionality within the jetpack air traffic control application.

**Instance Variables**: `flights`, `accidentAlerts`

**Key Methods**: `addFlight()`, `removeFlight()`, `getFlights()`, `reportAccident()`, `getAccidentAlerts()`
...
**Purpose**: Models bridge geometry with position, dimensions, and visual properties for

**Instance Variables**: `angle`

**Key Methods**: `getX()`, `getY()`, `getLength()`, `getWidth()`

### Building3D

**File**: `Building3D.java`  
**Package**: `com.example.model`

**Purpose**: Models building geometry with position, dimensions, and visual properties for

**Instance Variables**: `x`, `y`, `width`, `depth`, `height`, `color`, `type`, `hasWindows`, `floors`

**Key Methods**: `containsPoint()`, `distanceTo()`, `getX()`, `getY()`, `getWidth()`, `getLength()`, `getHeight()`, `getType()`, `getColor()`, `hasWindows()`, `getFloors()`
...
**Purpose**: Models a city entity containing spatial boundaries (width, height) and a registry of parking spaces

**Instance Variables**: `name`, `width`, `height`, `parkingSpaces`

**Key Methods**: `getName()`, `getWidth()`, `getHeight()`, `getParkingSpaces()`, `addParkingSpace()`

### CityModel3D

**File**: `CityModel3D.java`  
**Package**: `com.example.model`

**Purpose**: Models citymodel geometry with position, dimensions, and visual properties for

**Instance Variables**: `cityName`, `buildings`, `roads`, `bridges`, `houses`, `cityMap`, `mapWidth`, `mapHeight`, `random`

**Key Methods**: `getCityName()`, `getMapImage()`, `getMapWidth()`, `getMapHeight()`, `getRoads()`, `getBridges()`, `getHouses()`, `isWater()`, `getTerrainType()`, `getBuildingsNear()`, `getBuildings()`
...
**Purpose**: Establishes a two-dimensional grid structure with defined width and height, providing the spatial

**Instance Variables**: `width`, `height`

**Key Methods**: `getWidth()`, `getHeight()`
...
**Purpose**: Models house geometry with position, dimensions, and visual properties for

**Instance Variables**: `height`

**Key Methods**: `getX()`, `getY()`, `getWidth()`, `getLength()`, `getHeight()`
...
**Purpose**: Models a jetpack aircraft within the air traffic control system, storing essential identification

**Instance Variables**: `callsign`, `pilotName`, `available`

**Key Methods**: `getCallsign()`, `getPilotName()`, `isAvailable()`, `setAvailable()`
...
**Purpose**: Provides jetpackflight functionality within the jetpack air traffic control application.

**Instance Variables**: `jetpackId`, `x`, `y`, `active`

**Key Methods**: `getJetpackId()`, `getX()`, `getY()`, `isActive()`, `setPosition()`, `setActive()`

### ParkingSpace

**File**: `ParkingSpace.java`  
**Package**: `com.example.model`

**Purpose**: Models a physical parking location within a city where jetpacks can safely land, be stored, and

**Instance Variables**: `id`, `x`, `y`, `occupied`

**Key Methods**: `getId()`, `getX()`, `getY()`, `isOccupied()`, `occupy()`, `vacate()`
...
**Purpose**: Represents a radio transceiver operating on a designated frequency, enabling air traffic controllers

**Instance Variables**: `frequency`, `enabled`

**Key Methods**: `getFrequency()`, `isEnabled()`, `setEnabled()`, `transmit()`

### RadioCommandExecutor

**File**: `RadioCommandExecutor.java`  
**Package**: `com.example.model`

**Purpose**: Provides radiocommandexecutor functionality within the jetpack air traffic control application.

**Key Methods**: `executeCommand()`

### RadioMessage

**File**: `RadioMessage.java`  
**Package**: `com.example.model`

**Purpose**: Models a single radio communication message with sender/receiver identification, content payload,

**Instance Variables**: `sender`, `receiver`, `content`, `type`

**Key Methods**: `getSender()`, `getReceiver()`, `getContent()`, `getType()`

### RadioMessageFormatter

**File**: `RadioMessageFormatter.java`  
**Package**: `com.example.model`

**Purpose**: Provides radiomessageformatter functionality within the jetpack air traffic control application.

**Key Methods**: `format()`

### RadioTransmissionLogger

**File**: `RadioTransmissionLogger.java`  
**Package**: `com.example.model`

**Purpose**: Provides radiotransmissionlogger functionality within the jetpack air traffic control application.

**Instance Variables**: `transmissions`

**Key Methods**: `logTransmission()`, `getTransmissions()`
...
**Instance Variables**: `width`, `height`, `parkingSpaces`

**Key Methods**: `getWidth()`, `getHeight()`, `getParkingSpaces()`, `addParkingSpace()`
...
**Purpose**: Models road geometry with position, dimensions, and visual properties for
...
**Purpose**: Encapsulates weather state (e.g., Clear/Sunny, Rain, Fog, Storm) and severity classifications

**Instance Variables**: `currentWeather`, `currentSeverity`

**Key Methods**: `getCurrentWeather()`, `setCurrentWeather()`, `getCurrentSeverity()`, `setCurrentSeverity()`

## Package: `com.example.navigation`

### NavigationCalculator

**File**: `NavigationCalculator.java`  
**Package**: `com.example.navigation`

**Purpose**: Provides navigationcalculator functionality within the jetpack air traffic control application.

**Key Methods**: `calculateDistance()`, `calculateCompassDirection()`, `calculateDirectionWithEmoji()`, `calculateAngle()`, `calculateNextPosition()`, `hasReachedTarget()`, `normalizeAngle()`, `calculateBearing()`
...
**Purpose**: Provides parkingspace functionality within the jetpack air traffic control application.

**Instance Variables**: `id`, `location`, `isOccupied`

**Key Methods**: `getId()`, `getLocation()`, `isOccupied()`, `getX()`, `getY()`, `occupy()`, `vacate()`

### ParkingSpaceGenerator

**File**: `ParkingSpaceGenerator.java`  
**Package**: `com.example.parking`

**Purpose**: Provides parkingspacegenerator functionality within the jetpack air traffic control application.

**Key Methods**: `generateParkingSpaces()`, `getTargetSpaces()`

### ParkingSpaceManager

**File**: `ParkingSpaceManager.java`  
**Package**: `com.example.parking`

**Purpose**: Manages parkingspace instances across the Air Traffic Controller system, providing

**Instance Variables**: `parkingSpaces`, `city`

**Key Methods**: `initializeParkingSpaces()`, `updateParkingAvailability()`, `getParkingSpaces()`
...
**Purpose**: Provides radio functionality within the jetpack air traffic control application.

**Instance Variables**: `frequency`, `messageQueue`, `random`, `commandExecutor`, `messageFormatter`, `transmissionLogger`

**Key Methods**: `registerFlight()`, `registerFlightState()`, `unregisterFlight()`, `giveNewCoordinates()`, `giveNewAltitude()`, `clearForTakeoff()`, `clearForLanding()`, `issueEmergencyDirective()`, `broadcastToAll()`, `provideWeatherInfo()`, `requestPositionReport()`, `reportAccident()`, `clearAccidentReport()`, `getTransmissionLog()`, `clearTransmissionLog()`
...
**Instance Variables**: `flightRegistry`, `flightStateRegistry`
...
**Purpose**: Provides radiomessage functionality within the jetpack air traffic control application.

**Instance Variables**: `sender`, `receiver`, `message`, `timestamp`, `type`, `acknowledged`

**Key Methods**: `getSender()`, `getReceiver()`, `getMessage()`, `getTimestamp()`, `getType()`, `isAcknowledged()`, `setAcknowledged()`
...
**Instance Variables**: `controllerCallSign`

**Key Methods**: `formatCoordinateInstruction()`, `formatAltitudeInstruction()`, `formatTakeoffClearance()`, `formatLandingClearance()`, `formatEmergencyDirective()`, `formatBroadcast()`, `formatWeatherInfo()`, `formatPositionRequest()`, `formatAccidentReport()`, `formatAccidentCleared()`, `formatHandoffMessage()`, `formatPilotAcknowledgment()`, `formatHandoffAcknowledgment()`, `getControllerCallSign()`, `setControllerCallSign()`
...
**Instance Variables**: `transmissionLog`, `isTransmitting`

**Key Methods**: `transmit()`, `logTransmission()`, `transmitAndLog()`, `getTransmissionLog()`, `clearTransmissionLog()`, `getTransmissionCount()`, `isTransmitting()`, `printLog()`

## Package: `com.example.renderer`

### JOGLRenderer3D

**File**: `JOGLRenderer3D.java`  
**Package**: `com.example.renderer`

**Purpose**: Models joglrenderer geometry with position, dimensions, and visual properties for

**Instance Variables**: `cityModel`, `glut`
...
**File**: `CityMapAnimationController.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymapanimationcontroller functionality within the jetpack air traffic control application.

**Instance Variables**: `jetpackFlights`, `flightStates`, `currentWeather`, `performanceMonitor`, `radarTapeWindow`, `weatherManager`, `rand`, `updateCounter`, `collisionCheckCounter`

**Key Methods**: `startAnimation()`, `actionPerformed()`, `stopAnimation()`

### CityMapFlightInitializer

**File**: `CityMapFlightInitializer.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymapflightinitializer functionality within the jetpack air traffic control application.

**Key Methods**: `initializeFlights()`

### CityMapJetpackListFactory

**File**: `CityMapJetpackListFactory.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymapjetpacklistfactory functionality within the jetpack air traffic control application.

**Key Methods**: `createJetpackListPanel()`, `insertUpdate()`, `removeUpdate()`, `changedUpdate()`

### CityMapLoader

**File**: `CityMapLoader.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymaploader functionality within the jetpack air traffic control application.

**Instance Variables**: `mapIcon`, `mapImage`, `mapWidth`, `mapHeight`

**Key Methods**: `getMapIcon()`, `getMapImage()`, `getMapWidth()`, `getMapHeight()`, `loadCityMap()`

### CityMapPanel

**File**: `CityMapPanel.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Specialized Swing JPanel providing -related visualization and user interaction.

**Instance Variables**: `radarTapeWindow`, `logManager`, `city`, `jetpacks`, `mapPanel`, `mapWithJetpacks`, `jetpackFlights`, `flightStates`, `radarTape`, `weatherLabel`, `dateTimeLabel`, `parkingSpaces`, `weatherBroadcastArea`, `jetpackMovementArea`, `radioInstructionsArea`

**Key Methods**: `hideJetpack()`, `showJetpack()`, `setVisibleJetpacks()`, `setShowCitySelectionCallback()`, `setOpenRadarTapeCallback()`, `setRadarTapeWindow()`, `updateAllFlightStatesRadarWindow()`, `paintComponent()`, `getPreferredSize()`, `keyPressed()`, `updateWeatherBroadcast()`, `appendJetpackMovement()`, `actionPerformed()`, `stopAnimation()`, `getJetpackFlights()`

### CityMapPanelFactory

**File**: `CityMapPanelFactory.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Specialized Swing JPanel providing factory-related visualization and user interaction.

**Instance Variables**: `panel`, `textArea`, `panel`, `label`

**Key Methods**: `createDateTimePanel()`, `actionPerformed()`, `createParkingAvailabilityPanel()`, `createWeatherBroadcastPanel()`, `createJetpackMovementPanel()`, `keyReleased()`, `createRadioInstructionsPanel()`, `getPanel()`, `getTextArea()`, `getLabel()`

### CityMapRadioInstructionHandler

**File**: `CityMapRadioInstructionHandler.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymapradioinstructionhandler functionality within the jetpack air traffic control application.

**Instance Variables**: `city`, `cityRadio`, `currentWeather`, `logManager`, `updater`, `random`

**Key Methods**: `issueRandomRadioInstruction()`

### CityMapRenderer

**File**: `CityMapRenderer.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Handles rendering logic for citymap using appropriate

**Instance Variables**: `city`, `mapIcon`, `gridRenderer`, `performanceMonitor`

**Key Methods**: `paintMapComponent()`, `getPreferredSize()`

### CityMapUpdater

**File**: `CityMapUpdater.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Provides citymapupdater functionality within the jetpack air traffic control application.

**Instance Variables**: `city`, `logManager`, `weatherBroadcastArea`, `jetpackMovementArea`, `radioInstructionsArea`

**Key Methods**: `updateWeatherBroadcast()`, `appendJetpackMovement()`, `appendRadioInstruction()`

### CityMapWeatherManager

**File**: `CityMapWeatherManager.java`  
**Package**: `com.example.ui.citymap`

**Purpose**: Manages mapweather instances across the Air Traffic Controller system, providing

**Instance Variables**: `city`, `currentWeather`, `jetpackFlights`, `flightStates`, `parkingSpaces`, `cityRadio`, `radarTapeWindow`, `parentComponent`, `updater`, `weatherLabel`

**Key Methods**: `setWeatherLabel()`, `startWeatherTimer()`, `stopWeatherTimer()`, `updateWeatherDisplay()`, `groundAllFlights()`, `initiateEmergencyLandings()`
...
**Purpose**: Serves as the main GUI frame orchestrating the entire user experience for the Jetpack Air Traffic

**Instance Variables**: `currentCity`, `mainPanel`, `citySelectionPanel`, `cityMapPanel`, `currentWeather`, `currentDayTime`, `radarTapeWindow`, `logManager`, `jetpackManager`, `timerManager`, `displayUpdater`, `consolePanel`, `configManager`, `sessionManager`

**Key Methods**: `actionPerformed()`

### JetpackTrackingWindow

**File**: `JetpackTrackingWindow.java`  
**Package**: `com.example.ui.frames`

**Purpose**: Provides jetpacktrackingwindow functionality within the jetpack air traffic control application.

**Instance Variables**: `updateTimer`, `jetpack`, `flight`, `cityName`, `allFlights`, `allStates`, `animationController`, `renderPanel`, `useJOGL`, `cityName`, `flight`, `allFlights`, `allStates`, `cityModel`

**Key Methods**: `windowClosing()`, `mousePressed()`, `mouseReleased()`, `mouseDragged()`, `mouseWheelMoved()`, `paintComponent()`

### RadarTapeWindow

**File**: `RadarTapeWindow.java`  
**Package**: `com.example.ui.frames`

**Purpose**: Provides radartapewindow functionality within the jetpack air traffic control application.

**Instance Variables**: `radarTextArea`, `messages`, `timeFormatter`, `city`, `logWriter`

**Key Methods**: `addMessage()`

## Package: `com.example.ui.panels`

### CityControlPanel

**File**: `CityControlPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing control-related visualization and user interaction.

**Instance Variables**: `dateTimePanel`, `weatherPanel`, `movementPanel`, `radioPanel`

**Key Methods**: `getDateTimePanel()`, `getWeatherPanel()`, `getMovementPanel()`, `getRadioPanel()`
...
**Key Methods**: `startAnimation()`, `stopAnimation()`
...
**Key Methods**: `createJetpackListPanel()`
...
**Key Methods**: `createCityMapPanel()`
...
**Key Methods**: `updateWeather()`

### CitySelectionPanel

**File**: `CitySelectionPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing selection-related visualization and user interaction.

**Instance Variables**: `cityComboBox`, `selectButton`, `instructionLabel`, `citySelectedCallback`

**Key Methods**: `getSelectedCity()`

### ConsoleOutputPanel

**File**: `ConsoleOutputPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing consoleoutput-related visualization and user interaction.

**Instance Variables**: `consoleOutput`

**Key Methods**: `appendMessage()`, `clear()`, `getConsoleArea()`

### DateTimeDisplayPanel

**File**: `DateTimeDisplayPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing datetimedisplay-related visualization and user interaction.

**Instance Variables**: `dateTimeDisplayArea`

**Key Methods**: `updateDisplay()`, `getDisplayArea()`

### JOGL3DPanel

**File**: `JOGL3DPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing jogl3d-related visualization and user interaction.

**Instance Variables**: `allFlights`, `renderer`, `glPanel`, `flight`, `cityModel`, `flightStates`, `updateTimer`, `hudOverlay`, `positionLabel`, `statusLabel`, `terrainLabel`, `callsignLabel`, `cityLabel`, `cameraAzimuth`, `cameraElevation`

**Key Methods**: `hideJetpack()`, `showJetpack()`, `setVisibleJetpacks()`, `registerPanel()`, `unregisterPanel()`, `stopUpdateTimer()`, `getGLPanel()`, `getRenderer()`, `removeNotify()`

### JetpackListPanel

**File**: `JetpackListPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing jetpacklist-related visualization and user interaction.

**Instance Variables**: `jetpackListArea`, `jetpacks`

**Key Methods**: `updateList()`

### JetpackMovementPanel

**File**: `JetpackMovementPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing jetpackmovement-related visualization and user interaction.

**Instance Variables**: `jetpackMovementArea`

**Key Methods**: `appendMovement()`, `clearMovement()`, `getMovementArea()`

### MapDisplayPanel

**File**: `MapDisplayPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing display-related visualization and user interaction.

**Instance Variables**: `mapIcon`, `parkingRenderer`, `shadingRenderer`

**Key Methods**: `setParkingRenderer()`, `setShadingRenderer()`, `paintComponent()`, `getPreferredSize()`
...
**Instance Variables**: `parkingSpaces`

**Key Methods**: `addParkingSpace()`, `getParkingSpaces()`

### RadioInstructionsPanel

**File**: `RadioInstructionsPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing radioinstructions-related visualization and user interaction.

**Instance Variables**: `radioInstructionsArea`

**Key Methods**: `updateInstructions()`, `getInstructionsArea()`

### WeatherBroadcastPanel

**File**: `WeatherBroadcastPanel.java`  
**Package**: `com.example.ui.panels`

**Purpose**: Specialized Swing JPanel providing weatherbroadcast-related visualization and user interaction.

**Instance Variables**: `weatherBroadcastArea`

**Key Methods**: `updateBroadcast()`, `getBroadcastArea()`
...
**Instance Variables**: `accidents`, `flightStates`, `cameraAzimuth`, `cameraElevation`, `cameraDistance`, `glut`, `mouseAzimuth`, `mouseElevation`, `mouseDistance`, `lastMouseY`, `dragging`, `glu`, `flight`, `cityModel`, `nearbyJetpacks`

**Key Methods**: `mousePressed()`, `mouseReleased()`, `mouseDragged()`, `mouseWheelMoved()`, `init()`, `dispose()`, `display()`, `setCamera()`, `updateData()`, `reshape()`
...
**Purpose**: Models renderer geometry with position, dimensions, and visual properties for

**Key Methods**: `renderScene()`

### UIComponentFactory

**File**: `UIComponentFactory.java`  
**Package**: `com.example.ui.utility`

**Purpose**: Provides uicomponentfactory functionality within the jetpack air traffic control application.

**Key Methods**: `createReadOnlyTextArea()`, `createScrollPane()`, `createScrollPaneAlwaysVisible()`, `createBorderLayoutPanel()`, `createFlowLayoutPanel()`, `setPreferredSize()`, `createButton()`, `createLabel()`, `createCenteredLabel()`, `createComboBox()`
...
**Purpose**: Manages config instances across the Air Traffic Controller system, providing

**Instance Variables**: `properties`, `configFile`

**Key Methods**: `loadConfig()`, `saveConfig()`, `getCollisionCriticalDistance()`, `getCollisionAccidentDistance()`, `getWeatherAlertSeverity()`, `getParkingUpdateInterval()`, `getLastCity()`, `setGridVisible()`, `setProperty()`
...
**Purpose**: Provides debugconfig functionality within the jetpack air traffic control application.

**Key Methods**: `isEnabled()`
...
**Purpose**: Manages session instances across the Air Traffic Controller system, providing

**Key Methods**: `saveSession()`, `exportRadarLog()`, `exportAccidentReport()`, `listSessions()`, `getSessionsDirectory()`
...
**Purpose**: Provides geometryutils functionality within the jetpack air traffic control application.
...
**File**: `JetpackFactory.java`  
**Package**: `com.example.utility`

**Purpose**: Provides jetpackfactory functionality within the jetpack air traffic control application.
...
**Purpose**: Provides maploader functionality within the jetpack air traffic control application.
...
**Purpose**: Provides simple start/stop timing functionality to measure elapsed time for operations, enabling

**Instance Variables**: `startTime`, `endTime`
...
**Purpose**: Provides reflectionhelper functionality within the jetpack air traffic control application.

**Key Methods**: `invokeMethod()`

### TimezoneHelper

**File**: `TimezoneHelper.java`  
**Package**: `com.example.utility`

**Purpose**: Provides timezonehelper functionality within the jetpack air traffic control application.

**Key Methods**: `formatWithTimezone()`

### WaterDetector

**File**: `WaterDetector.java`  
**Package**: `com.example.utility`

**Purpose**: Provides waterdetector functionality within the jetpack air traffic control application.
...
**Key Methods**: `createPoint()`, `calculateDistance()`, `calculateAngle()`, `moveToward()`, `isWithinRange()`, `clamp()`
...
**Key Methods**: `generateJetpacksForCity()`
...
**Purpose**: Provides performancemonitor functionality within the jetpack air traffic control application.

**Instance Variables**: `frameCount`, `currentFPS`, `lastFPSUpdate`, `visible`

**Key Methods**: `setVisible()`, `isVisible()`, `toggleVisibility()`, `tick()`, `render()`, `getFPS()`
...
**Instance Variables**: `mapImage`, `width`, `height`

**Key Methods**: `isWater()`, `getRandomLandPoint()`, `findClosestLandPoint()`, `getWidth()`, `getHeight()`
...
**Purpose**: Provides daytime functionality within the jetpack air traffic control application.

**Instance Variables**: `currentTime`, `timeOfDay`, `timeRanges`

**Key Methods**: `setTime()`, `updateToCurrentTime()`, `updateTime()`, `getColorScheme()`, `getTimeOfDayDescription()`, `getCurrentTime()`, `getTimeOfDay()`, `getTimeRanges()`, `getFormattedTime()`
...
**Purpose**: Provides weather functionality within the jetpack air traffic control application.

**Instance Variables**: `weatherTypes`, `currentWeather`, `currentSeverity`, `temperature`, `windSpeed`, `visibility`, `weatherID`, `lastUpdated`

**Key Methods**: `sendWeatherBroadcast()`, `changeWeather()`, `changeWeatherRandomly()`, `isSafeToFly()`, `getWeatherTypes()`, `getCurrentWeather()`, `getCurrentSeverity()`, `getTemperature()`, `setTemperature()`, `getWindSpeed()`, `setWindSpeed()`, `getVisibility()`, `setVisibility()`, `getWeatherID()`, `getLastUpdated()`
